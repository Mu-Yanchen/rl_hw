...
def plot_number_steps(step_cache_qlearning, step_cache_SARSA):
    ...
    Args:
        step_cache_qlearning, step_cache_SARSA  --  type(list) contains cumulative_reward, which is used to plot a draw
...
def main():
    ...
    ax_q = generate_heatmap(q_table_qlearning,'Q-learning')
    print(ax_q)
    
    print("Visualize SARSA")
    ax_SARSA = generate_heatmap(q_table_SARSA,'SARSA')
    print(ax_SARSA)
